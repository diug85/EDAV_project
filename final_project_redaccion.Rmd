...
To test how statistically significant are these results we ran correlation hypothesis tests. In consideration that the relation will not necessarily linear we decided to run both parametric (Pearson) and not-parametric (Spearman) hypothesis test for $H_0=\rho\let0$ vs $H_1=\rho>0$ that resulted in the following *p-values*:
