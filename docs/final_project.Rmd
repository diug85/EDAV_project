...
write.csv(assignments2,"docs/topics_assignments.csv")
```

In the following link you can see the d3 tool: [d3TopicModellingTool](https://bernacho.github.io/EDAV_project/d3_lda.html){target="_blank"}  
